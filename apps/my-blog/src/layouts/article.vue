<template>
  <client-only>
    <div class="w-screen h-screen flex flex-col overflow-hidden">
      <div class="w-full h-10 shrink-0 bg-gray-200 flex items-center justify-between px-4">
        <h1>童话的博客</h1>
        <globalSearch />
      </div>
      ...
      <div class="flex size-full gap-3 overflow-hidden">
        <aside class="md:!block !hidden w-[260px] shrink-0 h-full overflow-hidden" :class="{ '!w-[84px]': collapsed }">
          <contentNavigation
        ...
        <aside class="md:!block !hidden w-[200px] shrink-0 h-full overflow-y-auto">
